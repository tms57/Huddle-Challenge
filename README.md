Still trying to figure out **responsive** svg footer.
In the footer, I had to change the Huddle SVG to have a fill colour of white (otherwise it doesn't show at all).
